      ...
      <div class="modal__content_prof menu_cont">
        ...
        <div class="container_prof">
          <div class="profile-container">
            ...
            <button class="like-button" onclick="">お気に入りに追加</button>
            <button class="like-button" onclick="">訪問済みに追加</button>
            </div>
            ...
            <div class="week-container">
              <div class="week-table week-table-date" v-html="scheduleDates[0]">05月10日（金）</div>

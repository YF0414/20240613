...
<p class="caria_message">ソープラブ会員サービスは完全無料！セラピスト探しがとっても便利になるサービスが満載！お気に入り機能、訪問済みセラピスト一覧はメモ機能も搭載！過去に利用したお店、セラピストも漏れなく管理できます。まだ会員登録がお済でない方は是非ご登録下さいませ。登録は1分で終わります。</p>
...
<form class="login-form">
  ...
  <div class="prof-select">
    ...
    <option value="">---</option>
    <option value="">吉原</option>
    <option value="18">川崎</option>
    <option value="19">すすきの</option>
    <option value="20">金津園</option>
    <option value="21">雄琴</option>
    <option value="23">福原</option>
    <option value="24">中洲</option>
    </select>
  </div>
...
<div class="poricy_message">
  <p>ソープラブ運営事務局（以下、弊社という）個人情報保護法その他の法令を誠実に遵守し、ソープラブ（以下、本サービスという）のご利用時にご提供頂いた個人情報について次の通り管理しております。個人情報とは、ユーザー個人に関する情報であって、その情報を構成する氏名、住所、電話番号、メールアドレス、生年月日、その他の記述等によりユーザー個人を識別できるものを指します。</p>

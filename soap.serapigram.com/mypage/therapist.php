    ...
    <div class="container_photo">
      <div class="grid-item_photo">
        <a data-micromodal-trigger="remodal_prof_modal">
          <img src="<?=$com_href?>/img/soap01.jpg" loading="lazy">
        </a>
        <p class="at_name">名前 / 年齢</p>
      </div>
      <div class="grid-item_photo">
        <a data-micromodal-trigger="remodal_prof_modal">
          <img src="<?=$com_href?>/img/soap02.jpg" oading="lazy">
        </a>
        <p class="at_name">名前 / 年齢</p>
      </div>
      <div class="grid-item_photo">
        <a data-micromodal-trigger="remodal_prof_modal">
          <img src="<?=$com_href?>/img/soap03.jpg" loading="lazy">
        </a>
        <p class="at_name">名前 / 年齢</p>
      </div>
      <div class="grid-item_photo">
        <a data-micromodal-trigger="remodal_prof_modal">
          <img src="<?=$com_href?>/img/soap04.jpg" loading="lazy">
        </a>
        <p class="at_name">名前 / 年齢</p>
      </div>
      <div class="grid-item_photo">
        <a data-micromodal-trigger="remodal_prof_modal">
          <img src="<?=$com_href?>/img/soap05.jpg" oading="lazy">
        </a>
        <p class="at_name">名前 / 年齢</p>
      </div>
      <div class="grid-item_photo">
...
<div class="like_box">
  ...
  <div class="like_box_in">
    <div class="profile-header_story hand_push">
      <a data-micromodal-trigger="remodal_prof_modal">
      <img src="<?=$com_href?>/img/soap05.jpg" >
